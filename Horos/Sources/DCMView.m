            ...
            switch (key)
            {
                ...
                case SetKeyImageAction:
                    if( [self is2DViewer] == YES)
                        [[self windowController] setKeyImage: self];
                    break;
                case MaskImageCreateAction:
 		            NSLog(@"MaskImage YJKKEEKEEE");
                    break;
                case ExportROICoordinatesAction:
                    // ############################################
                    NSLog(@"--------------Start Logging--------------");
                    NSLog(@"Located At:  %@", [self dataFilePath]);
                    ...
                    for( int i = [dcmRoiList count]-1; i>=0;  i--)
                    {
                        NSArray *tmpRoiList = [dcmRoiList objectAtIndex:i];
