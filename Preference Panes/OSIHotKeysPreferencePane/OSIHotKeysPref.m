...
- (void) mainViewDidLoad
{
	...
	// create array of MutableDictionaries containing names of actions
		NSArray *actions = [NSArray arrayWithObjects:[NSMutableDictionary dictionaryWithObjectsAndKeys:	NSLocalizedString(@"Default WW/WL", nil), @"action", nil],
                                            ...
                                            [NSMutableDictionary dictionaryWithObjectsAndKeys:NSLocalizedString(@"Mask Image Create", nil), @"action", nil],
                                            [NSMutableDictionary dictionaryWithObjectsAndKeys:NSLocalizedString(@"Export ROI Coordinates", nil), @"action", nil],
											nil];
